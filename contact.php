                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon">+234</span>
                                    </div>
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/cartdiv" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
